              ...
              >
                ...
                <div className="pt-4 flex flex-col gap-4">
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-[#E5E5E5] rounded-[6px] text-[13.1px] text-[#0A0A0A] placeholder:text-[#737373] outline-none focus:border-[#2D2555]/40 transition-colors resize-none bg-transparent"
                  ...
                  <input
                    ...
                    className="w-full h-9 px-3 border border-[#E5E5E5] rounded-[6px] text-[12.7px] text-[#737373] placeholder:text-[#737373] outline-none focus:border-[#2D2555]/40 transition-colors bg-transparent"
                  />
                  ...
                  <input
                    ...
                    className="w-full h-9 px-3 border border-[#E5E5E5] rounded-[6px] text-[12.9px] text-[#737373] placeholder:text-[#737373] outline-none focus:border-[#2D2555]/40 transition-colors bg-transparent"
                  />
