                  ...
                  <div className="flex gap-4">
                    <div className="flex flex-col gap-1 flex-1">
                      ...
                      <input
                        ...
                        className="w-full h-9 px-3 border border-[#E5E5E5] rounded-[6px] text-[14px] text-[#0A0A0A] outline-none focus:border-[#2D2555]/40 transition-colors bg-transparent"
                      />
                    </div>
                    <div className="flex flex-col gap-1 flex-1">
                  ...
                  <div className="flex flex-col gap-[6.4px] pb-[5.6px]">
                    ...
                    <div className="relative flex items-center h-5">
                      <input
                        ...
                        style={{
                          background: `linear-gradient(to right, #068653 ${progress}%, rgba(6,134,83,0.1) ${progress}%)`,
                        }}
                      />
                    </div>
                  </div>
